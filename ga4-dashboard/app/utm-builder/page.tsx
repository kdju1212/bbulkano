...
// UTM 빌더 — 키워드ID/키워드 목록과 URL·UTM 값을 받아
// 네이버 검색광고 '키워드 URL 일괄수정' 업로드용 CSV를 만들어준다.
...
function buildUrl(base: string, utm: UtmParams, keyword: string): string {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-500">
          키워드ID·키워드 목록과 UTM 값을 입력하면 네이버 검색광고 &apos;키워드 URL
          일괄수정&apos; 업로드용 CSV를 만들어줍니다. (템플릿 1~6행 안내문 포함, CP949 인코딩)
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="space-y-3">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium">
              모바일 URL <span className="text-xs font-normal text-zinc-400">(선택 — 비우면 PC URL 사용)</span>
            </label>
            <input
              value={mobileUrl}

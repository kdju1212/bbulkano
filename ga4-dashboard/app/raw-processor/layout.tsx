...
// RAW 가공 공통 레이아웃 — 로그인 확인 + 광고주별 서브 탭.
// 광고주마다 가공 포맷(파이썬 코드)이 달라서 페이지를 분리한다.
...
const CLIENT_TABS = [
  { href: "/raw-processor/dongkook", label: "동국제약" },
  { href: "/raw-processor/gangchon", label: "강촌레일파크" },
  { href: "/raw-processor/kg-eduone", label: "KG에듀원" },
];

export default function RawProcessorLayout({ children }: { children: React.ReactNode }) {
